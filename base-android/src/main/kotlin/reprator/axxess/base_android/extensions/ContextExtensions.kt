package reprator.axxess.base_android.extensions
...
import reprator.axxess.base_android.util.isAndroidNOrLater
import java.util.*
...
val Context.countryCodeString
    get() = if (isAndroidNOrLater)
